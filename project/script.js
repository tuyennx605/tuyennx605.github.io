$(document).ready(()=>{
    ...
    var peer = new Peer({key: 'peerjs', host: 'https://tuyennx605.github.io/project/',port: 443, secure: true});  //co id thi cho vao (id nay phai la khac nguoi khac nhe), ko thi no lay ngau nhien
